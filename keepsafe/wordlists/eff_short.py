...
Provenance: EFF short wordlist 1, (c) Electronic Frontier Foundation,
https://www.eff.org/large-numbers-and-letters. Redistributed under CC BY 4.0;
see LICENSE third-party section.

Words appear in the exact order of the published dice-index file
(index 1111 -> WORDS[0], ..., index 6666 -> WORDS[1295]).
"""
